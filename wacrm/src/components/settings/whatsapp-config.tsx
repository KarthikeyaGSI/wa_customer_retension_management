...
export function WhatsAppConfig() {
  ...
  const [appControlEnabled, setAppControlEnabled] = useState(false);
  ...
  const fetchConfig = useCallback(async (acctId: string) => {
    ...
    try {
      ...
      if (data) {
        ...
        setAppControlEnabled(data.api_key ? true : false);
      } else {
        setConfig(null);
        setPhoneNumberId('');
        setWabaId('');
          ...
          >
            <div className="flex items-center justify-between gap-2 flex-wrap">
              <div className="flex items-center gap-2">
                ...
                >
                  {isRegistered
                    ? 'Registered — Meta will deliver events to Marketing ko WA CRM'
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                ...
                , then paste it here so Marketing ko WA CRM can subscribe the number —
