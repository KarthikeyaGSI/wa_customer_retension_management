...
export interface DispatchArgs {
  ...
  /** When true, don't send the reply — just return the draft text. */
  draftOnly?: boolean
  /** Override the inbound message text (for playground testing). */
  testMessage?: string
}
...
export async function dispatchInboundToAiReply(
  args: DispatchArgs,
): Promise<{ draft_reply?: string; tokens_used?: number } | void> {
  const { accountId, conversationId, contactId, configOwnerUserId, draftOnly, testMessage } = args
